...
/* Site chrome over the experience. The navbar belongs to the browsing levels
   (globe 1–3 and the country cover 3); the data pages (4) are immersive and
...
export default function SiteNav() {
  ...
  return (
    <header
      style={{
        maxHeight: visible ? "68px" : "0px",
        opacity: visible ? 1 : 0,
        pointerEvents: visible ? "auto" : "none",
        transition: "max-height 0.5s ease, opacity 0.5s ease",
      }}
      className={`fixed top-0 left-0 right-0 z-[100] flex items-center h-[68px] ${headerBg}`}
    >
