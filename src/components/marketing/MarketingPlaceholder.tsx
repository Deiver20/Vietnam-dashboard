...
export default function MarketingPlaceholder({
  ...
  if (!originalFile || failed) {
    return (
      <div
        className={`relative flex items-center justify-center bg-[#0a2748] border border-dashed border-[#0f3160] rounded-lg text-[#94959b] text-xs font-semibold select-none ${className}`}
